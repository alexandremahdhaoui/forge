...
// It handles both direct URIs (e.g., "forge://go-build") and alias URIs (e.g., "alias://my-builder").
...
type EngineSpec struct {
	...
	// EngineURI is the engine reference (e.g., "forge://go-build", "alias://my-builder")
	EngineURI string
