...
func TestParseEngineURI_GoProtocol(t *testing.T) {
	tests := []struct {
		...
		{
			name:             "external module github.com",
			engineURI:        "go://github.com/user/repo/cmd/mytool",
			forgeVersion:     "v1.2.3",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "go",
			wantArgsContains: "github.com/user/repo/cmd/mytool@latest",
			wantErr:          false,
		},
		{
		...
		{
			name:             "external module with explicit version",
			engineURI:        "go://github.com/user/repo/cmd/tool@v1.0.0",
			forgeVersion:     "v2.0.0",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "go",
			wantArgsContains: "github.com/user/repo/cmd/tool@v1.0.0",
			wantErr:          false,
		},
		{
			name:             "external module gitlab.com",
			engineURI:        "go://gitlab.com/org/project/cmd/cli",
			forgeVersion:     "v1.0.0",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "go",
			wantArgsContains: "gitlab.com/org/project/cmd/cli@latest",
			wantErr:          false,
		},
		{
			name:             "external module with empty version defaults to latest",
			engineURI:        "go://github.com/user/repo/cmd/tool@",
			forgeVersion:     "v1.0.0",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "go",
			wantArgsContains: "github.com/user/repo/cmd/tool@latest",
			wantErr:          false,
		},
		{
			...
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "go",
			wantArgsContains: "go-test", // In local mode: ./cmd/go-test, in prod: go-test@v2.0.0
			wantErr:          false,
		},
		{
			name:             "internal sub-path extracts last component",
			engineURI:        "go://cmd/tool",
			forgeVersion:     "v1.0.0",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "go",
			wantArgsContains: "tool", // In local mode: ./cmd/tool, in prod: tool@v1.0.0
			wantErr:          false,
		},
		{
