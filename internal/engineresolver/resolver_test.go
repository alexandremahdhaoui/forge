...
func TestParseEngineURI_GoProtocol(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:             "member form delegates to forge-factory run",
			engineURI:        "forge://github.com/user/repo/cmd/mytool",
			forgeVersion:     "v1.2.3",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "forge-factory",
			wantArgsContains: "run --quiet github.com/user/repo/cmd/mytool -- --mcp",
			wantErr:          false,
		},
		{
			name:             "with version suffix is ignored",
			engineURI:        "forge://go-test@v1.0.0",
			forgeVersion:     "v2.0.0",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "go",
		...
		{
			name:             "member form keeps an explicit dev rev",
			engineURI:        "forge://github.com/user/repo/cmd/tool@v1.0.0",
			forgeVersion:     "v2.0.0",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "forge-factory",
		...
		{
			name:             "member form on any host",
			engineURI:        "forge://gitlab.com/org/project/cmd/cli",
			forgeVersion:     "v1.0.0",
			wantEngineType:   EngineTypeMCP,
			wantCommand:      "forge-factory",
			wantArgsContains: "gitlab.com/org/project/cmd/cli",
			wantErr:          false,
		},
		{
