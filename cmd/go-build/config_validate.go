...
// handleConfigValidate validates go-build engine configuration.
// It checks the spec fields:
//   - args ([]string, optional) - additional arguments to pass to go build
//   - env (map[string]string, optional) - environment variables to set for the build
//
...
// validateSpec validates the go-build spec fields.
