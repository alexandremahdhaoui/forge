...
func headeredFile(path string) map[string]interface{} {
	return map[string]interface{}{
		"path":    path,
		"content": "// Code generated by gui-gen (forge-dev-codegen). DO NOT EDIT.\n",
	}
}
...
func TestAModuleRootWithTheGeneratedHeaderOnLineOneIsAccepted(t *testing.T) {
	dir := t.TempDir()
	writeKindFixture(t, dir, customKindYaml())

	require.NoError(t, generateCell(t, dir, answerFiles(headeredFile("src/grpc/mod.rs"))))
	require.FileExists(t, filepath.Join(dir, "src", "grpc", "mod.rs"))
}
...
func TestATypeScriptModuleRootWithTheGeneratedHeaderIsAccepted(t *testing.T) {
	dir := t.TempDir()
	writeKindFixture(t, dir, customKindYaml())

	require.NoError(t, generateCell(t, dir, answerFiles(headeredFile("src/index.ts"))))
	require.FileExists(t, filepath.Join(dir, "src", "index.ts"))
}

func TestAPathThatIsNoModuleRootIsRefusedEvenWithTheGeneratedHeader(t *testing.T) {
	dir := t.TempDir()
	writeKindFixture(t, dir, customKindYaml())
