...
// It validates the generic-builder spec fields:
...
func handleConfigValidate(
	...
	log.Printf("Validating generic-builder config for spec: %s", input.SpecName)

	output := validateGenericBuilderSpec(input.Spec)
...
// validateGenericBuilderSpec validates the generic-builder spec fields.
func validateGenericBuilderSpec(spec map[string]interface{}) *mcptypes.ConfigValidateOutput {
